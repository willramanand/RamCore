...
/**
 * Fired by {@link RegionTracker} when a player enters a {@link RuleRegion}. Not cancellable; the
 * tracker reports movement it has already observed.
 */
public final class RegionEnterEvent extends Event {
    ...
    public RegionEnterEvent(@NotNull Player player, @NotNull RuleRegion region) {
